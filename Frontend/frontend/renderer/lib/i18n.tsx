...
export const tr = {
  ...
  'mode.indicator': 'Oto mod · onay kartı yok',
  'mode.indicatorTitle': 'Oto modda hiçbir işlem onay sormaz. Değiştirmek için: Ayarlar → Çalışma modu.',
...
export const en: Record<keyof typeof tr, string> = {
  ...
  'mode.indicator': 'Auto mode · no approval cards',
  'mode.indicatorTitle': 'Nothing asks for approval in auto mode. To change: Settings → Work mode.',
