...
export const tr = {
  ...
  'settings.modeAutoExplain': 'Oto modda hiçbir yerde onay kartı çıkmaz; Unity MCP’ye doğrudan bağlanan dış AI istemcileri (ör. Claude Code) dahil.',
  'settings.modeStepExplain': 'Adım modunda her değişiklik ve komut için onay kartı çıkar.',
  // ChatPanel
...
export const en: Record<keyof typeof tr, string> = {
  ...
  'settings.modeAutoExplain': 'In auto mode no approval card appears anywhere, including for external AI clients connected straight to Unity MCP (e.g. Claude Code).',
  'settings.modeStepExplain': 'In step mode every change and command shows an approval card.',
  // ChatPanel
