...
export const tr = {
  ...
  // Sohbet dalları (sekmeler)
  'branch.tabs': 'Sohbet dalları',
  'branch.new': 'Buradan dallandır — yeni sekmeye yalnız metin geçmişi kopyalanır, araç çıktıları kopyalanmaz',
  'branch.newBlocked': 'Tur bitince ya da bekleyen kart yanıtlanınca dallandırabilirsin',
  'branch.close': 'Sekmeyi kapat — dal silinmez, kapalı dallardan geri açılır',
  'branch.closed': 'Kapalı dallar ({sayi})',
  'branch.busy': 'Bu sohbette bir tur sürüyor ya da onay bekleniyor; dal o bitince açılabilir.',
  'branch.failed': 'Dal oluşturulamadı.',
  'branch.hideFailed': 'Sekme güncellenemedi.',
  'branch.menuRename': 'Yeniden adlandır',
  'branch.menuClose': 'Kapat',
...
export const en: Record<keyof typeof tr, string> = {
  ...
  'branch.tabs': 'Chat branches',
  'branch.new': 'Branch from here — the new tab gets the text history only; tool outputs are not copied',
  'branch.newBlocked': 'You can branch once the turn ends or the open card is answered',
  'branch.close': 'Close tab — the branch is kept and can be reopened from closed branches',
  'branch.closed': 'Closed branches ({sayi})',
  'branch.busy': 'A turn is running in this chat or it is waiting for approval; branch once it finishes.',
  'branch.failed': 'Could not create the branch.',
  'branch.hideFailed': 'Could not update the tab.',
  'branch.menuRename': 'Rename',
  'branch.menuClose': 'Close',
